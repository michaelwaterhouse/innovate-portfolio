...
@app.route("/michael")
def michael_page():
    return render_template("michael.html", user_name = "Michael", favourite_thing = "music")

@app.route("/bobby")
def bobby_page():
    return render_template("bobby.html", user_name = "Bobby the Sausage Dog", favourite_thing = "Tennis ball")
